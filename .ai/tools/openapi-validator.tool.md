...
# Lint the spec
spectral lint src/main/resources/META-INF/api.yaml

# Validate with swagger-cli
npm install -g @apidevtools/swagger-cli
swagger-cli validate src/main/resources/META-INF/api.yaml
```
...
grep -E '^  /api/' src/main/resources/META-INF/api.yaml
```
