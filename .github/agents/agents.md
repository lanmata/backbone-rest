...
|------|------|-----------|---------|
| `orchestrator.agent.md` | **Orchestrator** | ✅ | Decomposes requests, delegates to specialized agents, tracks progress, delivers consolidated report |
...
| `database-architect.agent.md` | Database Architect | ❌ | JPA entity/query advice (entities in external `com.prx:persistence`) |
...
- Agents collaborate by passing context through the Orchestrator — not directly to each other.
