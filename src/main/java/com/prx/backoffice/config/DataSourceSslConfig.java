...
import com.prx.backoffice.constant.BackboneAppConstants;
import com.prx.backoffice.constant.keys.BackboneMessage;
            ...
            if (sslRootCert != null && !sslRootCert.isEmpty()) {
                ...
                if (sslRootCert.startsWith("classpath:")) {
                    ...
                    try (InputStream in = getClass().getClassLoader().getResourceAsStream(resourcePath)) {
                        ...
                        throw new StandardException(BackboneAppConstants.APPLICATION_NAME, BackboneMessage.DATABASE_CERTIFICATE_ERROR, e);
                    }
                }
