 ...
 * Provides message codes and status descriptions for different role-feature-related operations.
 *
 * @version 1.0.0, 12-02-2021
 */
public enum RoleFeatureMessageKey implements MessageType {
    /**
     * Error during role-feature linking.
     */
    ...
    /**
     * Role-feature linking created successfully.
     */
    ...
    /**
     * Constructor for RolFeatureMessageKey enum.
     *
     * @param code the code of the message
     * @param status the status description of the message
     */
    RoleFeatureMessageKey(int code, String status){
        this.code = code;
        this.status = status;
    }
